/* PrismJS 1.28.0
https://prismjs.com/download.html#themes=prism-tomorrow&languages=latex&plugins=line-numbers+toolbar+copy-to-clipboard+match-braces */
...
/* Custom Plugin: Load Entire File */
(function () {
	...
	if (!Prism.plugins.toolbar) {
		console.warn('Load Entire File plugin loaded before Toolbar plugin.');
...
/* Plugin: Copy to Clipboard Button */
(function () {
