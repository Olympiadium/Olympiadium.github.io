...
<a href="{{ site.homeurl }}">Olympiadium</a> > <a href="{{ site.homeurl }}mathematical-olympiads/">Mathematical Olympiads</a> > <a href="{{ site.homeurl }}mathematical-olympiads/algebra/">Algebra</a> > <a href="{{ site.homeurl }}mathematical-olympiads/algebra/olym-2a/">Olym 2A</a><br><br>
<div class="row">
...
<ul class="actions vertical">
  <li><a href="{{ site.baseurl }}{{ page.permalink }}theorems-and-techniques" class="button fit">이론 및 기술</a></li>
  ...
  <li><a href="{{ site.baseurl }}{{ page.permalink }}olym-handouts" class="button fit">Olym 통신강좌</a></li>
</ul>
</div>
</div>
